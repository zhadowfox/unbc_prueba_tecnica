...
<body class="bg-gradient-to-b from-slate-950 to-slate-600 h-screen bg-no-repeat bg-cover font-[poppins] pb-50">
...
<div class="flex-2 justify-center w-auto h-full px-3 md:px-0 md:mx-16 mx-0 mb-16">
    @livewire('createuser')
    @livewire('userscrud')
</div>
